...
Simple to use contact form

== Description ==

Simple contact form supporting easy form creation / customization. Saves enquiries to local site as well as sending out the usual emails.
...
= 0.9.8 =
* New: Show error message on mandatory fields not being filled in
...
= 0.9.5 =
* Added: Ability to disallow links on text inputs to avoid spammers.

= 0.9.4 =
* fixed: session and menu
...
= 0.6 =
* Enhancement: added anchor tag just above form so that on pages with a lot of content before the form, after a bad submission, the page auto-scrolls back to the form.
...
= 0.9.5 =
Added the ability to disallow links on text inputs to avoid spammers.
